 ...
 * ## abstruct
 * 
 * `dtsdoc` is a documentation generator for TypeScript ambient source file(`.d.ts`). You can also use [markdown](http://daringfireball.net/projects/markdown/syntax) to document your code. 
 *
