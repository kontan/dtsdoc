...
(function (DTSDoc) {
        ...
        ASTTypeName.prototype.build = function (b, scope) {
            ...
            b.span('', function () {
                if(_this.name == "any" || _this.name == "void") {
                    ...
                    b.a('', typeNameLinks[_this.name], _this.name);
                } else {
                    var member = scope.searchType(_this);
                    if(member) {
                        b.a('', "#" + member.getLinkString(), _this.name);
                    } else {
                        b.span('', _this.name);
                    }
                }
    ...
    var ASTClassMember = (function () {
        ...
        ASTClassMember.prototype.build = function (b, scope) {
            var _this = this;
            b.div('ts_class_member_container', function () {
                _this.buildMember(b);
                if(_this.docs) {
                    _this.docs.build(b);
                }
