...
(function (DTSDoc) {
    ...
    var ASTImport = (function (_super) {
        ...
        ASTImport.prototype.build = function (b) {
        };
        return ASTImport;
    })(ASTModuleMember);
...
(function (DTSDoc) {
    ...
    function pProgram(watcher) {
        return seq(function (s) {
            ...
            s(eof);
            if(s.success()) {
                var mod = new DTSDoc.ASTModule("(globalg)", members);
                members.forEach(function (m) {
                    m.parent = mod;
                });
                mod.updateHierarchy();
...
(function (paralet) {
    var Parser = (function () {
        function Parser(options, remains) {
        ...
        Parser.prototype.parse = function (inputs, unexpected) {
            var remains = [];
    ...
    paralet.Parser = Parser;    
})(exports.paralet || (exports.paralet = {}));
var paralet = exports.paralet;
...
function toHTMLDocument(input) {
    ...
    if(result.type === DTSDoc.GenerationResultType.Success) {
        ...
        var styles = fs.readFileSync(dir + 'style.css').toString();
        var template = fs.readFileSync(dir + 'template.html').toString();
